Test Driven Development [![N|Solid](https://travis-ci.org/ruslantkachuk/JMP2_TDD.svg?branch=master)](https://travis-ci.org/ruslantkachuk/JMP2_TDD.svg?branch=master)
-----------------------
### TECHNOLOGY STACK
